...
public class FileChooserComponent {
     ...
     * @return
     */
    public VirtualFile showFileSelectionDialog(@NotNull String title, @Nullable VirtualFile toSelect, @Nullable VirtualFile... roots) {
        final FileChooserDescriptor descriptor = new FileChooserDescriptor(true,true,true,true,true,false);
        descriptor.setTitle(title);
        //if (null != roots) {
        //    descriptor.setRoots(roots);
        //}
