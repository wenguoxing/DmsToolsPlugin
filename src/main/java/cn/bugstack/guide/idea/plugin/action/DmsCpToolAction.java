 ...
 * @Version 1.0
 */
public class DmsCpToolAction extends AnAction {

    private IProjectGenerator projectGenerator = new ProjectGeneratorImpl();

    public DmsCpToolAction() {
    }
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        DmsCpToolUI cpToolUI = new DmsCpToolUI(project,psiFile,0);
        //是否允许用户通过拖拽的方式扩大或缩小你的表单框，我这里定义为true，表示允许
        cpToolUI.setResizable(true);
        cpToolUI.show();

        //if (new DmsCpToolUI2().showAndGet()) {
        //    // 按下了 OK 键
