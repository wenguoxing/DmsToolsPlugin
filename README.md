...
<!-- Plugin description -->
**DmsToolsPlugin** is a repository that provides a pure template to make it easier to create a new plugin project.

Support Ap-java,Ap-jsp,Ap-properties,Batch-java,ApBatch-java etc.
